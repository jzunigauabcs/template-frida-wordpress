<!-- Funciones -->
<?php   
    load_theme_textdomain( 'frida-wp', get_template_directory() . '/languages' );
            ...
            <div class="row clearfix">
                <div class="col-1">
                    ...
                    <nav id="nav-main">
                        <ul>
                            <li>
                                <a href="#banner"> <?php _e('Inicio','frida-wp');?></a>
                            </li>
                            <li>
...
<!-- Aqui ira el Layout de Scripts.Template -->
