      ...
      <div class="row align-items-start poppins-regular">
        ...
        <div class="col-sm-12 col-md-12 col-lg-3 px-5 custom-border-start">
          ...
          <div class="row py-3">
            ...
            <div lass="mb-1"><p><span class="poppins">$180</span> Adulto (mexicano)</p></div>
            <div lass="mb-1"><p><span class="poppins">$100</span> Menor de edad</p></div>
            <div lass="mb-1"><p><span class="poppins">$360</span> Extranjero</p></div>
          </div>
          <div class="row py-3">
            <h5 class="pb-3 tu-visita-tarifas">Personas con capacidades diferentes</h5>
            <div lass="mb-1"><p><span class="poppins">$60</span> Adulto</p></div>
          </div>
          <div class="row py-3">
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 px-5">
          ...
          <div class="row py-3">
            ...
            <div lass="mb-1"><p>Niños menores de 10 años, acompañados por un adulto</p></div>
          </div>
