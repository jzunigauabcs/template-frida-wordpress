...
if ( ! function_exists( 'ozeum_trx_addons_add_theme_vars' ) ) {
	add_filter( 'ozeum_filter_add_theme_vars', 'ozeum_trx_addons_add_theme_vars', 10, 2 );
	function ozeum_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'ozeum_trx_addons_get_css' ) ) {
	add_filter( 'ozeum_filter_get_css', 'ozeum_trx_addons_get_css', 10, 2 );
	function ozeum_trx_addons_get_css( $css, $args ) {
...
.sc_slider_controls .slider_pagination_current,
.sc_slider_controls .slider_pagination_total {
	color: {$colors['text_dark']};
}
.sc_slider_controls .slider_progress_bar {
	background-color: {$colors['text_link']};
...
.slider_container .slider_pagination_wrap.slider_outer_pagination_pos_bottom_outside .swiper-pagination-bullet,
...
.slider_container .slider_pagination_wrap.slider_outer_pagination_pos_bottom_outside .swiper-pagination-bullet:hover,
.slider_container .slider_pagination_wrap.slider_outer_pagination_pos_bottom_outside .swiper-pagination-bullet.swiper-pagination-bullet-active,
.slider_outer.slider_outer_pagination_pos_bottom_outside .swiper-pagination-bullet:hover,
.slider_outer.slider_outer_pagination_pos_bottom_outside .swiper-pagination-bullet.swiper-pagination-bullet-active {
   	background-color: {$colors['text_dark']};
}
...
.sc_events_extra .sc_events_item_button .sc_button:hover {
    color: {$colors['inverse_hover']} !important;
    border-color: {$colors['text_dark']} !important;
    background-color: {$colors['text_dark']} !important;
}
...
.sc_portfolio_default .sc_portfolio_item .sc_portfolio_item_subtitle a {
    color: {$colors['text_light']} !important;
}
.sc_portfolio_default .sc_portfolio_item .sc_portfolio_item_subtitle a:hover {
    color: {$colors['text_dark']} !important;
}
...
.sc_price_item {
	...
	background-color: {$colors['bg_color']};
	border-color: {$colors['bd_color']};
    -webkit-box-shadow: 0 0 6px {$colors['text_dark_01']};
	-moz-box-shadow: 0 0 6px {$colors['text_dark_01']};
	box-shadow: 0 0 6px {$colors['text_dark_01']};
}

.sc_price_item:hover { 
    -webkit-box-shadow: 0 0 8px {$colors['text_dark_02']};
	-moz-box-shadow: 0 0 8px {$colors['text_dark_02']};
	box-shadow: 0 0 8px {$colors['text_dark_02']};
}
...
.team_member_projects .sc_portfolio_item_info .sc_portfolio_item_button .sc_button_simple,
.team_member_projects .sc_portfolio_item_info .sc_portfolio_item_button .sc_button_simple:hover {
    color: {$colors['text_dark']} !important;
    background-color: transparent !important;
}

.team_member_projects .sc_portfolio_item_info .sc_portfolio_item_button .sc_button_simple:before,
.team_member_projects .sc_portfolio_item_info .sc_portfolio_item_button .sc_button_simple:hover:before {
   background-color: {$colors['text_dark']};
}

.team_member_projects .sc_portfolio_item_info .sc_portfolio_item_button .sc_button_simple:after {
   color: {$colors['text_dark']} !important;
   border-color: {$colors['bd_color']};
}

.team_member_projects .sc_portfolio_item_info .sc_portfolio_item_button .sc_button_simple:hover:after {
   color: {$colors['text_dark']} !important;
   border-color: {$colors['text_dark']};
}
...
#trx_addons_login_popup.trx_addons_popup button.mfp-close:hover {
	border-color: {$colors['alter_bd_hover']};
}
