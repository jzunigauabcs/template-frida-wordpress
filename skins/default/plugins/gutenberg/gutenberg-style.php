...
if ( ! function_exists( 'ozeum_gutenberg_add_theme_vars' ) ) {
	add_filter( 'ozeum_filter_add_theme_vars', 'ozeum_gutenberg_add_theme_vars', 10, 2 );
	function ozeum_gutenberg_add_theme_vars( $rez, $vars ) {
		return $rez;
	}
}
...
if ( ! function_exists( 'ozeum_gutenberg_get_css' ) ) {
	add_filter( 'ozeum_filter_get_css', 'ozeum_gutenberg_get_css', 10, 2 );
	function ozeum_gutenberg_get_css( $css, $args ) {
